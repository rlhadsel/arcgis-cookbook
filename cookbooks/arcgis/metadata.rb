...
depends          'arcgis-license-manager', '~> 5.2'
depends          'arcgis-egdb', '~> 2.1'
depends          'arcgis-enterprise', '~> 5.2'
depends          'arcgis-geoevent', '~> 5.2'
depends          'arcgis-notebooks', '~> 5.2'
depends          'arcgis-mission', '~> 5.2'
depends          'arcgis-insights', '~> 5.2'
depends          'arcgis-pro', '~> 5.2'
depends          'arcgis-repository', '~> 5.2'
depends          'arcgis-workflow-manager', '~> 5.2'
depends          'arcgis-video', '~> 5.2'
