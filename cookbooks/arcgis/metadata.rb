...
depends          'arcgis-license-manager', '~> 5.3'
depends          'arcgis-egdb', '~> 2.3'
depends          'arcgis-enterprise', '~> 5.3'
depends          'arcgis-geoevent', '~> 5.3'
depends          'arcgis-notebooks', '~> 5.3'
depends          'arcgis-mission', '~> 5.3'
depends          'arcgis-insights', '~> 5.3'
depends          'arcgis-pro', '~> 5.3'
depends          'arcgis-repository', '~> 5.3'
depends          'arcgis-workflow-manager', '~> 5.3'
depends          'arcgis-video', '~> 5.3'
